...
if __name__ == '__main__':
    ...
    ax2 = ax1.twinx()
    ax1.plot(epochs_range, train_losses, label='Train Loss', color='tab:blue')
    ax1.plot(epochs_range, val_losses,   label='Test Loss',  color='tab:orange')
    ax2.plot(epochs_range, train_accs,    label='Train Accuracy', color='tab:green')
    ax2.plot(epochs_range, val_accs,      label='Test Accuracy',  color='tab:red')
